...
const ctune_UI_KeyBinding_t bindings_fav_tab[] = {
    ...
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_QUIT, .description = CTUNE_UI_TEXT_HELP_QUIT, .key = CTUNE_UI_INPUTKEY_Q },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_VOLUP, .description = CTUNE_UI_TEXT_HELP_VOL_UP, .key = CTUNE_UI_INPUTKEY_PLUS },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_VOLDOWN, .description = CTUNE_UI_TEXT_HELP_VOL_DOWN, .key = CTUNE_UI_INPUTKEY_MINUS },
