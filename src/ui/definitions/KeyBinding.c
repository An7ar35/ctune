...
const ctune_UI_KeyBinding_t bindings_fav_tab[] = {
    ...
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_GO_BACK, .description = CTUNE_UI_TEXT_HELP_ESC, .key = CTUNE_UI_INPUTKEY_ESC },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_HELP, .description = CTUNE_UI_TEXT_HELP_KEY, .key = CTUNE_UI_INPUTKEY_F1 },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_TAB1, .description = CTUNE_UI_TEXT_HELP_CHANGE_TAB_1, .key = CTUNE_UI_INPUTKEY_1 },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_TAB2, .description = CTUNE_UI_TEXT_HELP_CHANGE_TAB_2, .key = CTUNE_UI_INPUTKEY_2 },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_TAB3, .description = CTUNE_UI_TEXT_HELP_CHANGE_TAB_3, .key = CTUNE_UI_INPUTKEY_3 },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_PLAY, .description = CTUNE_UI_TEXT_HELP_PLAYBACK_START, .key = CTUNE_UI_INPUTKEY_P },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_TRIGGER, .description = CTUNE_UI_TEXT_HELP_PLAYBACK_START, .key = CTUNE_UI_INPUTKEY_RETURN },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_RECORD, .description = CTUNE_UI_TEXT_HELP_RECORD_TOGGLE, .key = CTUNE_UI_INPUTKEY_CTRL_R },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_RESUME, .description = CTUNE_UI_TEXT_HELP_PLAYBACK_RESUME, .key = CTUNE_UI_INPUTKEY_R },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_STOP, .description = CTUNE_UI_TEXT_HELP_PLAYBACK_STOP, .key = CTUNE_UI_INPUTKEY_S },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_QUIT, .description = CTUNE_UI_TEXT_HELP_QUIT, .key = CTUNE_UI_INPUTKEY_Q },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_VOLUP_5, .description = CTUNE_UI_TEXT_HELP_VOL_UP, .key = CTUNE_UI_INPUTKEY_PLUS },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_VOLDOWN_5, .description = CTUNE_UI_TEXT_HELP_VOL_DOWN, .key = CTUNE_UI_INPUTKEY_MINUS },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_FAV, .description = CTUNE_UI_TEXT_HELP_TOGGLE_FAV, .key = CTUNE_UI_INPUTKEY_F },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_RSI_QUEUED, .description = CTUNE_UI_TEXT_HELP_OPEN_RSINFO_QUEUED, .key = CTUNE_UI_INPUTKEY_CTRL_I },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_FIND, .description = CTUNE_UI_TEXT_HELP_OPEN_RSFIND_FORM, .key = CTUNE_UI_INPUTKEY_CTRL_F },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_NEW, .description = CTUNE_UI_TEXT_HELP_OPEN_RSEDIT_FORM_NEW, .key = CTUNE_UI_INPUTKEY_N },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_EDIT, .description = CTUNE_UI_TEXT_HELP_OPEN_RSEDIT_FORM_EDIT, .key = CTUNE_UI_INPUTKEY_E },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_OPTIONS, .description = CTUNE_UI_TEXT_HELP_OPEN_OPTIONS, .key = CTUNE_UI_INPUTKEY_O },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_EMPTY, .action = CTUNE_UI_ACTION_NONE, .description = CTUNE_UI_TEXT_BLANK, .key = CTUNE_UI_INPUTKEY_NONE },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_RSI_SELECTED, .description = CTUNE_UI_TEXT_HELP_OPEN_RSINFO_SELECTED, .key = CTUNE_UI_INPUTKEY_I },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_GO_RIGHT, .description = CTUNE_UI_TEXT_HELP_OPEN_RSINFO_SELECTED, .key = CTUNE_UI_INPUTKEY_RIGHT },
...
static const ctune_UI_KeyBinding_t bindings_rsinfo[] = {
    ...
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_SCROLL_HOME, .description = CTUNE_UI_TEXT_HELP_SCROLL_HOME, .key = CTUNE_UI_INPUTKEY_HOME },
    { .entry_type = CTUNE_UI_KEYBINDING_TYPE_NORMAL, .action = CTUNE_UI_ACTION_SCROLL_LEFT, .description = CTUNE_UI_TEXT_HELP_SCROLL_LEFT, .key = CTUNE_UI_INPUTKEY_LEFT },
 ...
 */
static const char * ctune_UI_KeyBinding_getKeyText( ctune_UI_InputKey_e keyID ) {
