...
static const struct IconSet icons[CTUNE_UI_ICON_COUNT] = {
    ...
    [CTUNE_UI_ICON_UP_ARROW_B   ] = { .ascii = "-", .unicode = "▲" },
    [CTUNE_UI_ICON_DOWN_ARROW_B ] = { .ascii = "+", .unicode = "▼" },
    [CTUNE_UI_ICON_LEFT_ARROW_B ] = { .ascii = "<", .unicode = "◄" },
    [CTUNE_UI_ICON_RIGHT_ARROW_B] = { .ascii = ">", .unicode = "►" },
