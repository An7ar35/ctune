...
static const char * field_str[CTUNE_UI_TEXT_ENUM_COUNT] = {
    ...
    [CTUNE_UI_TEXT_WIN_TITLE_HELP_OPTIONMENU        ] = "[ Help::Options ]",
    [CTUNE_UI_TEXT_WIN_TITLE_HELP_SETOUTDIR         ] = "[ Help::Set output path ]",
    ...
    [CTUNE_UI_TEXT_WIN_TITLE_SETOUTDIR              ] = "[ Set output directory ]",
    ...
    [CTUNE_UI_TEXT_ICONS_ASCII                      ] = "Use ASCII icons",
    [CTUNE_UI_TEXT_ICONS_UNICODE                    ] = "Use Unicode icons",
    ...
    [CTUNE_UI_TEXT_SET_RECORDING_PATH               ] = "Edit recording path",
    ...
    [CTUNE_UI_TEXT_MENU_OPTIONS                     ] = "Options",
    [CTUNE_UI_TEXT_MENU_UI_THEME                    ] = "UI Theme",
    [CTUNE_UI_TEXT_MENU_STREAM_TIMEOUT              ] = "Stream timeout",
    [CTUNE_UI_TEXT_MENU_MOUSE                       ] = "Mouse",
    [CTUNE_UI_TEXT_MENU_MOUSE_CLICK_INTERVAL        ] = "Click interval",
    [CTUNE_UI_TEXT_MENU_PLUGINS                     ] = "Plugins",
    [CTUNE_UI_TEXT_MENU_PLUGINS_PLAYERS             ] = "Players",
    [CTUNE_UI_TEXT_MENU_PLUGINS_SOUND_SERVER        ] = "Sound Servers",
    [CTUNE_UI_TEXT_MENU_PLUGINS_RECORDING           ] = "Recording",
    [CTUNE_UI_TEXT_TRUE                             ] = "Yes",
    [CTUNE_UI_TEXT_FALSE                            ] = "No",
    [CTUNE_UI_TEXT_OK                               ] = "OK",
    [CTUNE_UI_TEXT_DEFAULT                          ] = "default",
    [CTUNE_UI_TEXT_CUSTOM                           ] = "custom",
    ...
    [CTUNE_UI_TEXT_HELP_PARENT_MENU                 ] = "Go back to parent menu",
    [CTUNE_UI_TEXT_HELP_CHILD_MENU                  ] = "Open sub-menu/trigger action",
    ...
    [CTUNE_UI_TEXT_HELP_RECORD_TOGGLE               ] = "Start/Stop recording of playing stream.",
