...
#define CTUNE_ERR_IO_PLUGIN_LOAD        ADD( CTUNE_ERR_IO, 11 )
#define CTUNE_ERR_IO_DISK_ACCESS_FAIL   ADD( CTUNE_ERR_IO, 12 )
#define CTUNE_ERR_IO_DISK_FULL          ADD( CTUNE_ERR_IO, 13 )
#define CTUNE_ERR_IO_FILE_FULL          ADD( CTUNE_ERR_IO, 14 )
#define CTUNE_ERR_IO_FILE_CLOSE_FAIL    ADD( CTUNE_ERR_IO, 15 )
#define CTUNE_ERR_IO_FILE_WRITE_FAIL    ADD( CTUNE_ERR_IO, 16 )
#define CTUNE_ERR_IO_MOUSE_ENABLE_FAIL  ADD( CTUNE_ERR_IO, 17 )
#define CTUNE_ERR_IO_MOUSE_DISABLE_FAIL ADD( CTUNE_ERR_IO, 18 )
...
#define CTUNE_ERR_CURL_INIT             ADD( CTUNE_ERR_NETWORK_IO, 13 )
#define CTUNE_ERR_CURL_WRITE_CALLBACK   ADD( CTUNE_ERR_NETWORK_IO, 14 )
#define CTUNE_ERR_HTTP_GET              ADD( CTUNE_ERR_NETWORK_IO, 15 )
