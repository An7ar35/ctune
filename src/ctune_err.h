...
#define CTUNE_ERR_BUFF_OVERFLOW         ADD( CTUNE_ERR_NONE,  1 )
#define CTUNE_ERR_BUFF_ALLOC            ADD( CTUNE_ERR_NONE,  2 )
#define CTUNE_ERR_MALLOC                ADD( CTUNE_ERR_NONE,  3 )
#define CTUNE_ERR_BAD_CAST              ADD( CTUNE_ERR_NONE,  4 )
#define CTUNE_ERR_BAD_FUNC_ARGS         ADD( CTUNE_ERR_NONE,  5 )
...
#define CTUNE_ERR_IO_PLUGIN_OPEN        ADD( CTUNE_ERR_IO,  4 )
#define CTUNE_ERR_IO_PLUGIN_CLOSE       ADD( CTUNE_ERR_IO,  5 )
#define CTUNE_ERR_IO_PLUGIN_LINK        ADD( CTUNE_ERR_IO,  6 )
#define CTUNE_ERR_IO_PLUGIN_ABI         ADD( CTUNE_ERR_IO,  7 )
#define CTUNE_ERR_IO_PLUGIN_NULL        ADD( CTUNE_ERR_IO,  8 )
#define CTUNE_ERR_IO_MOUSE_ENABLE_FAIL  ADD( CTUNE_ERR_IO,  9 )
#define CTUNE_ERR_IO_MOUSE_DISABLE_FAIL ADD( CTUNE_ERR_IO, 10 )
#define CTUNE_ERR_THREAD                 30
...
#define CTUNE_ERR_ALSA_INIT             ADD( CTUNE_ERR_AUDIO_OUT,  4 )
#define CTUNE_ERR_SNDIO_INIT            ADD( CTUNE_ERR_AUDIO_OUT,  5 )
