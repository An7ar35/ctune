...
| `UI::Mouse`                           | bool         | `false`         | Flag to enable mouse support                                                                                |
 | `UI::Mouse::Resolution`               | integer      | ncurses default | Mouse resolution (resolution between a button press and a release for it to be registered as a click event) |
 | `UI::Mouse::Resolution::Preset`       | integer      | `0`             | Mouse resolution preset ID                                                                                  |
